    ...
    <SbEditable content={content} key={content._uid}>
      <main>
        ...
        <div className={styles.newsitem}>
          ...
          {movies && movies.length > 0 && <SmallCardList items={movies} title="Related continents" type="movie"></SmallCardList>}
          {personalities && personalities.length > 0 && <SmallCardList items={personalities} title="Related countries" type="personality"></SmallCardList>}
